...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("⭕️ Owner ⭕️", url="https://t.me/XxDarklovexX")]
        ])
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("BACK", callback_data="start_data"),
                InlineKeyboardButton("ABOUT", callback_data="about_data")],
            [InlineKeyboardButton("⭕️ SUPPORT ⭕️", url="https://t.me/ADL_Drama")]
        ])
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("Create By", url="https://telegra.ph/file/f3a2aefab016e565b92fb.jpg")]
        ])
